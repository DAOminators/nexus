...
contract GigaRepo {
    ...
    mapping(string => mapping(string => string)) refAccessControl;
    ...
    function createAdminProposal(address concerning, Proposals Type) external onlyCommitter {
        require(
...
// Structure 
// committers are team members
// refs/ref keys are files
// proposals -> auth, deauth, idea, task(TBD)
// To implement -> ref wise file access for each committer, modify the modifier committeronly and use mapps
// impplement task deadline change
