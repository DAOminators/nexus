...
import { run } from './ertdfgcvb/programsJS/src/run.js';
import * as program from './ertdfgcvb/programsJS/cube.js';
import './ertdfgcvb/style.css';
...
const ErtdfgcvbBG = () => {
    ...
    return (
        <div className='fixed z-[-1] mix-blend-difference'>
